...
Aplikasi web sederhana untuk mengelola pembayaran SPP sekolah, dibuat dengan PHP dan MySQL. Proyek ini punya dua sisi: untuk Siswa dan untuk Admin.
...
### Untuk Admin:
- 🎨 **Dashboard Modern** dengan tema Gelap & Terang (bisa ganti-ganti!).
...
---
Dibuat oleh **saya dan teman-teman**
